...
const EMAIL = 'frankyfreky103@gmail.com';
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // Try PesaFlux API endpoint with enhanced headers to bypass bot protection
    const response = await fetch('https://api.pesaflux.co.ke/v1/initiatestk', {
      ...
      headers: {
        ...
        'Origin': 'https://canadavisa.netlify.app',
        'Referer': 'https://canadavisa.netlify.app/',
